        ...
        <div className='bg-base-300'>
            <div className='pt-10 pb-5 w-11/12 mx-auto'>
                ...
                <div className='grid sm:grid-cols-2  md:grid-cols-3 gap-6 my-10'>
                    {/* instructor john doe */}
                    <div className='px-4 py-8 bg-[#FFFFFF] shadow-sm border border-gray-300 rounded-xl hover:shadow-2xl hover:border-purple-300 group'>
                        <Image src={JohnDoeImage} alt='John Doe Image' width={100} height={100} className='rounded-full mx-auto group-hover:border-4 group-hover:border-blue-600 ' />
                    ...
                    <div className='px-4 py-8 bg-[#FFFFFF] shadow-sm border border-gray-300 rounded-xl hover:shadow-2xl hover:border-purple-300 group'>
                        <Image src={SophiaImage} alt='John Doe Image' width={100} height={100} className='rounded-full mx-auto group-hover:border-4 group-hover:border-blue-600' />
                        <div className='text-center my-5 space-y-2'>
                    ...
                    {/* instructor Sophia Davis */}
                    <div className='px-4 py-8 bg-[#FFFFFF] shadow-sm border border-gray-300 rounded-xl hover:shadow-2xl hover:border-purple-300 group'>
                        <Image src={JamesImage} alt='John Doe Image' width={100} height={100} className='rounded-full mx-auto group-hover:border-4 group-hover:border-blue-600' />
                        <div className='text-center my-5 space-y-2'>
